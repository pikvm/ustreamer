...
#define ENCODER_TYPES_STR_BASE "CPU, HW, M2M-VIDEO, M2M-IMAGE"

#if defined(WITH_FFMPEG) && defined(WITH_MEDIACODEC)
#define ENCODER_TYPES_STR ENCODER_TYPES_STR_BASE ", FFMPEG-VIDEO, MEDIACODEC"
#elif defined(WITH_FFMPEG)
#define ENCODER_TYPES_STR ENCODER_TYPES_STR_BASE ", FFMPEG-VIDEO"
#elif defined(WITH_MEDIACODEC)
#define ENCODER_TYPES_STR ENCODER_TYPES_STR_BASE ", MEDIACODEC"
#else
#define ENCODER_TYPES_STR ENCODER_TYPES_STR_BASE
#endif 
...
#ifdef WITH_FFMPEG
	US_ENCODER_TYPE_FFMPEG_VIDEO,
#endif
#ifdef WITH_MEDIACODEC
	US_ENCODER_TYPE_MEDIACODEC_VIDEO,
#endif
} us_encoder_type_e;
