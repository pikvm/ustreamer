...
#define ENCODER_TYPES_STR ENCODER_TYPES_STR_BASE ", LIBX264-VIDEO, MEDIACODEC"
#elif defined(WITH_LIBX264)
#define ENCODER_TYPES_STR ENCODER_TYPES_STR_BASE ", LIBX264-VIDEO"
